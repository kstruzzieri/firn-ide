...
export function ClearAllRunHistory():Promise<void>;

export function ClearRunHistoryRecord(arg1:string):Promise<void>;
...
export function DetectWorkspaces(arg1:string):Promise<Array<workspace.WorkspaceDef>>;
...
export function GetRunHistoryRecord(arg1:string):Promise<runhistory.Record>;

export function GetRunHistorySnapshot():Promise<runhistory.Snapshot>;
...
export function GetWorkspaceInfo(arg1:string):Promise<main.WorkspaceInfo>;
...
export function LSPDidOpen(arg1:string,arg2:string,arg3:number,arg4:string):Promise<void>;
...
export function RunGolemTurn(arg1:ai.TurnRequest):Promise<ai.TurnAdmission>;
