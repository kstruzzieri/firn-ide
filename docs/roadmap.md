...
| Future Features | **IN PROGRESS** | #44 implementation shipped via PR #206 (tracker still open); #45/#46 are unlocked; #226 Golem chat panel shipped via PR #262 on the #165 embedded runtime; #263 Phase 1 and slices A and B shipped via PRs #269/#270/#272, Slice C named profiles and the narrow-pane redesign via PR #333 (2026-09-18, closing #284/#308/#309/#310/#315), exposure chips, filled model cards and the model note via PR #343 (2026-09-20), and the staged-changes bar's deltas in the rows' amber-italic glyph via PR #347 (2026-09-21, closing #345), all after the release; #285 phase routing shipped via PR #287, and #271 center panel and undock shipped via PR #288; #264/#265, the polish follow-ups #289/#291, and the configuration-workspace follow-ups filed from its live gates and reviews (#293, #307, #311, #312 (its picker IA shipped in #333; tracker open), #314, #316-#323, #334-#342, #344, #348-#350) remain open |
...
2. **#263 — Golem configuration workspace, via PRs #269/#270/#272:** Phase 1
   ...
   (2026-09-20), and the staged-changes bar printing its capability and Think
   deltas in the rows' amber-italic glyph, one pill per changed capability,
   via PR #347 (2026-09-21, closing #345). Remaining: the add-use-case
   control, profile Export and Delete (cut from Slice C, gated on
   go-llm#537/#536), and Slice D (the inventory-backed picker: Refresh list,
   capability facts, tool_call tri-state and Probe, on the go-llm inventory
   and probe operations Firn's pin has carried since Slice B's bump to
   `bf94237`).
...
editor's exposure chips and model cards (PR #343) and the staged-changes
bar's amber-italic deltas (PR #347).
