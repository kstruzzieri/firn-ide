...
| Future Features | **IN PROGRESS** | #44 shipped via PR #206 and is closed; #45/#46 are unlocked; #226 Golem chat panel shipped via PR #262 on the #165 embedded runtime; #263 Phase 1 and slices A and B shipped via PRs #269/#270/#272, Slice C named profiles and the narrow-pane redesign via PR #333 (2026-09-18, closing #284/#308/#309/#310/#315), exposure chips, filled model cards and the model note via PR #343 (2026-09-20), the staged-changes bar's deltas in the rows' amber-italic glyph via PR #347 (2026-09-21, closing #345), each routing row's role line and the Defined models band via PR #354 (2026-09-24, closing #344/#348), and text separators for assistive technology via PR #357 (2026-09-25, closing #356), all after the release; #285 phase routing shipped via PR #287, and #271 center panel and undock shipped via PR #288; #264/#265, the polish follow-ups #289/#291, the role picker (#353), and the configuration-workspace follow-ups filed from its live gates and reviews (#293, #307, #311, #314, #316-#319, #321-#323, #335-#338, #340-#342, #349, #350, #355) remain open, with #312 and #339 closed as shipped in #333 and #334 folded into #353; the new-chat, run-profile and restore defects #359-#361 are scheduled by the release contracts |
...
1. **#44 — implemented via PR #206:** the native-dialog command palette, deterministic fuzzy matcher, late-bound command registry, and shared shortcuts shipped. The issue closed on 2026-07-30.
...
| Closed | #44 Command Palette | Shipped via PR #206; the issue closed on 2026-07-30. |
...
| P2 | #264 Golem durable multi-conversation | Persist and switch between conversations; the New chat reset shipped with #226 is the in-memory slice of this, and #361 (v0.14.0) makes it reset the backend thread too. Designed during v0.15.0 for v0.16.0. |
...
### #44: Command Palette ✅ IMPLEMENTED (PR #206; CLOSED)
Cmd/Ctrl+Shift+P opens a native-dialog palette backed by the shared late-bound command registry, deterministic fuzzy matching, keyboard navigation, and shortcut display. The implementation is merged and the issue is closed.
