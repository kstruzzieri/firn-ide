...
| Milestone 7: Git Integration | **COMPLETE** | #26-27 shipped (PR #162); #163 hunk-level staging shipped (PR #173, hardened PR #174); follow-ups #164/#166/#167/#169 |
...
1. **Git integration follow-ups (Milestone 7 shipped via PR #162)** — deepen the just-shipped feature. **#163** hunk-level staging shipped (PR #173, hardened PR #174). Next highest value: **#167** intent-to-add (`git add -N`) so new files diff, **#166** richer branch/VCS menu, **#169** editable diff, **#164** 3-way merge UI, and **#165** replacing the golem CLI shell-out with the go-llm library for the AI commit message (go-llm PR #262 is merged).
...
- [x] Hunk-level staging in the diff viewer (#163, PR #173; hardened PR #174)

Follow-ups: #164 3-way merge, #165 go-llm library, #166 branch menu,
#167 intent-to-add, #169 editable diff.
